...
import { readTable, deleteTable, replaceTable } from "../../services/table.js";
...
export default function Workspace() {
  ...
  // Redirect to URL with workflow ID if not present
  useEffect(() => {
    if (!urlWorkflowId && activeWorkflowId) {
      const currentPath = window.location.pathname;
      let targetPath = currentPath === '/workflow' || currentPath === '/' ? '/workspace' : currentPath;
      navigate(`${targetPath}?id=${activeWorkflowId}`, { replace: true });
    }
