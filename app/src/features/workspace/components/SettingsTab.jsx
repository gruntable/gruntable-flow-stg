...
function TableNameCombobox({
  ...
  // Reset input value only when switching to a different node
  useEffect(() => {
  ...
  const handleInputChange = (e) => {
    ...
    // Store raw value (with spaces) while typing
    // Don't auto-select existing table during typing - let user type freely
    setTableNames(t => ({ ...t, [node.id]: value }));
