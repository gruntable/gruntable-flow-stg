...
const TablePanel = memo(function TablePanel({ tables, activeTable, onChangeActive, onChangeTable, onCloseTable, onCloseAllTables, onOpenTable, onCreateTable, workflowId, loadingTableName, orchestratorStatus, isPolling, pollCount, onDeleteTable, onRenameTable, qcTableDirty, qcTableSaving, handleSaveTable }) {
          ...
          {names.map(name => {
            ...
            return (
              <Fragment key={name}>
                <button
                  data-tab-name={name}
                  onMouseDown={(e) => startTabDrag(e, name)}
                  style={{
                    flexShrink: 0,
                    padding: "8px 14px",
