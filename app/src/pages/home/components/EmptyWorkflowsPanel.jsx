    ...
    <div style={{
      ...
      <div style={{ ...S.col(8) }}>
        {[
          <span>
            Browse the <span
              style={{ fontWeight: 700, cursor: 'pointer', color: C.black }}
              onClick={() => navigate('/templates')}
            >templates</span> and pick one that fits your use case.
          </span>,
      ...
      <div style={{ ...S.flex(8), alignItems: 'center', marginTop: 8 }}>
        ...
        <span style={{ fontSize: 13, color: C.mid, cursor: 'pointer' }} onClick={() => navigate('/templates')}>or browse templates</span>
      </div>
    </div>
  );
}
